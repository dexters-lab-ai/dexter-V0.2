...
### Core Documentation
- [Technical Stack & Architecture](TECH_STACK.md)
- [API Documentation & Integration](API.md)
- [Features & Capabilities](FEATURES.md)
- [Architecture Overview](docs/core/ARCHITECTURE.md)
- [AI Core Services](docs/core/AI_CORE.md)
- [Context Management](docs/core/CONTEXT.md)
- [Message Processing](docs/core/MESSAGES.md)
...
### Primary Networks, on Registration
- Sonic
- Solana
- Base
- Avalanche
...
- Off ramping
- Defi positions
- Cross device agent use, between mobile and desktop app

## 📞 Contact & Support

- Documentation: https://docs.dexter-ai.io
- Support: support@dexter-ai.io
