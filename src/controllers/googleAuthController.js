...
const REDIRECT_URI = config.googleClientRedirect; 
// e.g. "https://yourdomain.com/api/google/callback"

// The scopes you need for Gmail and Calendar
const SCOPES = [
...
export function initiateGoogleAuth(req, res) {
  ...
  // You might store telegramId in session or state param
...
/**
 * Step 2: Handle callback from Google, store tokens in user doc
 */
